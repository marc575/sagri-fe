...
function Faqs() {
  return (
    <div className='container pb-12 mx-auto sm:px-6 relative'>
      <div
        className='h-120' 
        style={{
      ...
      <div className='flex flex-col lg:flex-row justify-between items-center gap-5 mx-2 md:mx-10 shadow-md p-6 rounded-xl absolute top-2/3 bg-white'>
        <img src={faq} alt="" className='w-full md:w-1/2' />
        <div className='space-y-3'>
          <h2 className='text-xl md:text-3xl xl:text-4xl font-bold capitalize'>Questions Fréquemment Posées</h2>
          ...
          <div className="collapse collapse-plus bg-base-100 border border-base-300">
            ...
            <div className="collapse-title font-semibold">Comment s’inscrire en tant qu’agriculteur ?</div>
          ...
          <div className="collapse collapse-plus bg-base-100 border border-base-300">
            ...
            <div className="collapse-title font-semibold">Est-ce que je peux acheter en tant que particulier ?</div>
          ...
          <div className="collapse collapse-plus bg-base-100 border border-base-300">
            <input type="radio" name="my-accordion-3" />
            <div className="collapse-title font-semibold">Comment suivre une commande ?</div>
